  ...
  return (
    <>
      ...
      <aside
        ...
        aria-label="Sidebar"
      >
        <div className="h-full overflow-y-auto bg-gray-50 px-3 py-4 dark:bg-[#BFCFBB]">
          {isSidebarOpen && (
            <button
              onClick={toggleSidebar}
          ...
          <ul className="space-y-2 font-medium">
            <li>
              <a
                href="/admin"
                className="group flex items-center rounded-lg p-2 text-gray-900 hover:bg-gray-100 hover:text-white dark:hover:bg-[#092928]"
              >
                <svg
                  className="h-5 w-5 text-gray-500 transition duration-75 group-hover:text-gray-900 dark:group-hover:text-white"
                  aria-hidden="true"
                  xmlns="http://www.w3.org/2000/svg"
                  fill="currentColor"
                  viewBox="0 0 22 21"
            ...
            <li>
              ...
              >
                <svg
                  className="h-5 w-5 flex-shrink-0 text-gray-500 transition duration-75 group-hover:text-gray-900 dark:group-hover:text-white"
                  aria-hidden="true"
                  xmlns="http://www.w3.org/2000/svg"
                  fill="currentColor"
                  viewBox="0 0 18 18"
            ...
            <li>
              ...
              >
                ...
                <span className="ms-3 flex-1 whitespace-nowrap">Process</span>
              </a>
            </li>
            <li>
              <a

"use client";
import { deleteData, getAllData, postData, updateData } from "@/api/apiClient";
...
export default function EditItem() {
  ...
  const handleEdit = async (e) => {
    ...
    try {
      await updateData("kaligraphyItem", selected, formData);
      setFormData({
        name: "",
        description: "",
        price: 0,
  ...
  return (
    <>
      ...
      <div className="p-4 sm:ml-52">
        ...
        {toggle && (
          <div className="fixed left-0 top-0 z-50 flex h-screen w-screen flex-col items-center justify-center bg-primaryWhite px-12">
            <button className="fixed left-0 top-0 p-4">
              <img
            ...
            <h1 className="pb-12 text-xl font-bold">Edit Item</h1>
            {formData.image && (
              <div>
                <img
                  src={formData.image}
                  alt="Selected"
                  className="h-32 w-32 object-cover pb-12"
                />
              </div>
            )}

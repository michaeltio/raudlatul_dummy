...
const ProfileEdit = () => {
  ...
  return (
    <div className="mx-6 flex flex-col font-ptserif md:mx-28 md:gap-0">
      <form onSubmit={handleSubmit} className="flex flex-col gap-16 md:flex-row md:items-center md:gap-32">
        ...
        <div className="justify-center">
          ...
          <div className="flex justify-center mt-16 md:absolute md:my-20 md:justify-center md:text-2xl">
            <button type="submit" className="rounded-full border-[0.1rem] border-black px-8 md:h-12">
              Save
            </button>
          </div>
        </div>

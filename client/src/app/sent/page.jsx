  ...
  return (
    <>
        <div id="mainSent" className="">
            ...
            <Sent img="tester.webp" title="Kaligrafi Surah Yasin 20x40" p1="Total 1 Product:" p2="Rp 1.250.000" p3="1x"/>
            <Sent img="tester.webp" title="Kaligrafi Surah Al-Fatihah 40x40" p1="Total 2 Product:" p2="Rp 4.250.000" p3="2x"/>
        </div>
    </>
  );
}